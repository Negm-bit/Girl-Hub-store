...
function initPageTransitions(){
 ...
 document.addEventListener('click',e=>{
   // Interactive controls inside product links must never trigger page navigation.
   // Quick-add / wishlist / form controls are handled by their own listeners below.
   if(e.target.closest('[data-add],[data-wish],[data-remove],[data-inc],[data-dec],button,input,select,textarea,form'))return;
